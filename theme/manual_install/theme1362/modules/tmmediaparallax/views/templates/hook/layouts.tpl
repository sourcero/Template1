                ...
                {foreach from=$item.child item=layout name=layout_info}
                    ...
                    {elseif $layout.type == 2}
                        <div style="position: relative" class="rd-parallax-layer" data-offset="{$layout.offset|escape:'htmlall':'UTF-8'}" data-speed="{$layout.speed|escape:'htmlall':'UTF-8'}" data-type="media" data-fade="{$layout.fade|escape:'htmlall':'UTF-8'}" data-direction="{$layout.inverse|escape:'htmlall':'UTF-8'}">
                            <div style="position: absolute; z-index: 999999; top: 0px; left: 0px; bottom: 0px; right: 0px; overflow: hidden; " data-vide-bg="mp4: {$base_url|escape:'htmlall':'UTF-8'}{$layout.video_mp4|escape:'htmlall':'UTF-8'}, webm: {$base_url|escape:'htmlall':'UTF-8'}{$layout.video_webm|escape:'htmlall':'UTF-8'}, poster: {$base_url|escape:'htmlall':'UTF-8'}{$layout.image|escape:'htmlall':'UTF-8'}" data-vide-options="posterType: {$layout.image_type|escape:'htmlall':'UTF-8'}, autoplay: true, loop: true, muted: true, position: 0% 0% volum:0" class="vide"></div>
                        </div>
